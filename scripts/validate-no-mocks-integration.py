...
def move_files_to_unit(violations: List[Tuple[str, int, str]], dry_run: bool = True) -> None:
...
def main():
    parser = argparse.ArgumentParser(description="Validate no mocks in integration tests")
    parser.add_argument(
        "--fix", 
        action="store_true", 
    ...
    print()
    print("📚 **DOCUMENTATION:**")
    print("- Integration Testing Guide: docs/development/testing/integration-testing.rst")
    print("- Agent OS Spec: .agent-os/specs/2025-09-06-integration-testing-consolidation/")
