...
class TestBaggageDict:
    ...
    def test_set_key(self, mock_context, mock_baggage) -> None:
        ...
        mock_baggage.set_baggage.assert_called_once_with("test_key", "test_value", baggage.context)
    ...
    def test_delete_key(self, mock_context, mock_baggage) -> None:
        ...
        assert isinstance(result, BaggageDict)
        assert result.context == new_context
        mock_baggage.set_baggage.assert_called_once_with("test_key", None, baggage.context)
    ...
    def test_non_string_values(self, mock_context, mock_baggage) -> None:
        ...
        assert isinstance(result, BaggageDict)
        mock_baggage.set_baggage.assert_called_once_with("number_key", "42", baggage.context)
    ...
    def test_boolean_values(self, mock_context, mock_baggage) -> None:
        ...
        assert isinstance(result, BaggageDict)
        mock_baggage.set_baggage.assert_called_once_with("bool_key", "True", baggage.context)
    ...
    def test_none_values(self, mock_context, mock_baggage) -> None:
        ...
        assert isinstance(result, BaggageDict)
        mock_baggage.set_baggage.assert_called_once_with("none_key", "None", baggage.context)
    ...
    def test_complex_values(self, mock_context, mock_baggage) -> None:
        ...
        assert isinstance(result, BaggageDict)
        mock_baggage.set_baggage.assert_called_once_with("complex_key", str(complex_value), baggage.context)
