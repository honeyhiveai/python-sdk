...
class TestPooledHTTPClient:
    ...
    def test_get(self):
        ...
        with patch.object(self.pool, 'get_connection', return_value=mock_http_client), \
            ...
            self.pool.return_connection.assert_called_once_with('https://example.com', mock_http_client)
    ...
    def test_post(self):
        ...
        with patch.object(self.pool, 'get_connection', return_value=mock_http_client), \
            ...
            assert response == mock_response
            mock_http_client.post.assert_called_once_with('https://example.com', json={'key': 'value'})
            self.pool.return_connection.assert_called_once_with('https://example.com', mock_http_client)
...
class TestPooledAsyncHTTPClient:
    ...
    async def test_async_get(self):
        ...
        with patch.object(pool, 'get_async_connection', return_value=mock_http_client), \
            ...
            assert response == mock_response
            mock_http_client.get.assert_called_once_with('https://example.com')
            pool.return_async_connection.assert_called_once_with('https://example.com', mock_http_client)
...
class TestGlobalCache:
    ...
    def test_close_global_cache(self):
