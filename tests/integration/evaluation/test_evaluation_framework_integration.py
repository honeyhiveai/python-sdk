...
class TestEvaluationAPIIntegration:
    ...
    def test_create_evaluation_run_integration(self, integration_client, integration_project_name, skip_if_no_real_credentials):
    ...
    def test_evaluation_workflow_end_to_end(self, integration_client, integration_project_name, skip_if_no_real_credentials):
    ...
    def test_large_dataset_api_integration(self, integration_client, integration_project_name, skip_if_no_real_credentials):
        ...
        run = create_evaluation_run(
            ...
            project=integration_project_name,
            results=results,
            metadata={"dataset_size": dataset_size, "evaluation_time": evaluation_time, "integration_test": True},
            client=integration_client
        )
