...
class HTTPInstrumentor:
    ...
    def uninstrument(self):
        ...
        wrapt.unwrap_function_wrapper(requests.Session, "request")
        
        # Uninstrument httpx
        wrapt.unwrap_function_wrapper(httpx.Client, "request")
        wrapt.unwrap_function_wrapper(httpx.AsyncClient, "request")
