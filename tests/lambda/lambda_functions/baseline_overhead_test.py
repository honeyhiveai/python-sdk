...
def measure_baseline_operations(iterations: int = 1000, work_per_iteration_ms: float = 1.0) -> Dict[str, Any]:
    ...
    for iteration in range(iterations):
        ...
        iteration_overhead = operation_creation_time + operation_ops_time + operation_completion_time
        measurements["overhead_simulation"].append(iteration_overhead)
    
    return measurements


def measure_bulk_baseline_operations(num_requests: int = 50, operations_per_request: int = 10, work_per_operation_ms: float = 20) -> Dict[str, Any]:
    ...
    return {
        ...
        "expected_work_time_ms": num_requests * operations_per_request * work_per_operation_ms,
    }
    ...
    try:
        ...
        if test_type == "bulk":
            ...
            results = {
                ...
                "simulated_overhead_stats": calc_stats(measurements["overhead_simulation"]),
