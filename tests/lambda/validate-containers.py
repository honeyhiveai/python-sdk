...
class LambdaContainerValidator:
    ...
    def validate_all(self) -> bool:
        ...
        if not self.build_container("Dockerfile.bundle-builder", "honeyhive-lambda:bundle-native"):
            success = False
        ...
        if success:
            ...
            for handler in test_functions:
                if not self.test_lambda_function("honeyhive-lambda:bundle-native", handler):
