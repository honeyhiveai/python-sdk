...
def test_dspy_integration():
    ...
    try:
        ...
        lm = dspy.OpenAI(model="gpt-3.5-turbo", api_key=openai_key, max_tokens=100)
        ...
        response = basic_qa(
            question="What is DSPy and how does it work with HoneyHive?"
        )
        ...
        with tracer.enrich_span(
            ...
            cot_response = cot_qa(
                question="Why is observability important for AI systems?"
            )
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                multi_response = multi_hop(
                    question="How does HoneyHive help with AI monitoring?"
                )
        ...
        with tracer.enrich_span(
            ...
            tech_response = tech_explainer(
                concept="OpenTelemetry tracing", audience="software developers"
            )
