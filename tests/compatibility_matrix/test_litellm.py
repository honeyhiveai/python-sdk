    ...
    try:
        ...
        response = litellm.completion(
            ...
            messages=[
                ...
                {"role": "user", "content": "Say hello and confirm this is a compatibility test for HoneyHive + LiteLLM integration."}
            ],
            max_tokens=100,
            temperature=0.1
        )
        ...
        with tracer.enrich_span(
            ...
            span_data = {
                ...
                "usage": provider_response.usage.dict() if hasattr(provider_response, 'usage') else None
            }
            print(f"✓ Provider-specific format response: {provider_response.choices[0].message.content}")
        ...
        with tracer.enrich_span(
            ...
            cost_response = litellm.completion(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "user", "content": "Explain AI observability in one sentence."}
                ],
                max_tokens=80,
                temperature=0.3,
            ...
            span_data = {
                ...
                "estimated_cost": cost,
                "usage": cost_response.usage.dict() if hasattr(cost_response, 'usage') else None,
                "user": "compatibility_test_user"
            }
            print(f"✓ Cost tracking response: {cost_response.choices[0].message.content}")
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                print(f"✓ Fallback test completed: {fallback_response.choices[0].message.content}")
