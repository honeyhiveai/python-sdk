            ...
            try:
                ...
                classify_response = client.classify(
                    ...
                    examples=[
                        ...
                        cohere.ClassifyExample(text="This is terrible.", label="negative"),
                        cohere.ClassifyExample(text="Technology is amazing.", label="positive"),
                ...
                span_data = {
                    ...
                    "confidence": classify_response.classifications[0].confidence if classify_response.classifications else None
                }
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                span_data = {
                    ...
                    "top_score": rerank_response.results[0].relevance_score if rerank_response.results else None
                }
