...
def test_google_vertexai_integration():
    ...
    try:
        ...
        print(
            f"✓ Vertex AI initialized (project: {gcp_project}, location: {gcp_location})"
        )
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                span_data = {
                    ...
                    "model": "gemini-pro",
                    "safety_ratings": (
                        len(gemini_response.candidates[0].safety_ratings)
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                code_response = code_model.predict(
                    prefix="def hello_world():", max_output_tokens=100, temperature=0.1
                )

                span_data = {"code_response": code_response.text, "model": "code-bison"}
