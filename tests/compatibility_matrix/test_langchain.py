...
def test_langchain_integration():
    ...
    try:
        ...
        llm = ChatOpenAI(
            model="gpt-3.5-turbo", temperature=0.1, openai_api_key=openai_key
        )
        ...
        messages = [
            ...
            HumanMessage(
                content="Say hello and confirm this is a LangChain compatibility test."
            ),
        ]
        ...
        with tracer.enrich_span(
            ...
            span_data = {"batch_size": len(topics), "results": batch_results}
