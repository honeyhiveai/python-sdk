    ...
    try:
        ...
        with tracer.enrich_span(
            ...
            generation_response = client.generate(
                model=ollama_model, prompt="What is 2+2? Answer briefly."
            )
        ...
        with tracer.enrich_span(
            ...
            try:
                embeddings_response = client.embeddings(
                    model=ollama_model, prompt="This is a test text for embedding."
                )
                ...
                print(
                    f"⚠️  Embeddings test failed (model may not support embeddings): {e}"
                )
        ...
        with tracer.enrich_span(
            ...
            conversation_response = client.chat(
                ...
                messages=[
                    ...
                    {
                        "role": "assistant",
                        "content": "That sounds great! Observability helps monitor AI systems.",
                    },
                    {
                        "role": "user",
                        "content": "What tools are commonly used for this?",
                    },
                ],
            )
            ...
            print(
                f"✓ Conversation response: {conversation_response['message']['content']}"
            )
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                span_data = {
                    "model_name": model_info.get("details", {}).get(
                        "family", "unknown"
                    ),
                    "parameter_size": model_info.get("details", {}).get(
                        "parameter_size", "unknown"
                    ),
                    "quantization_level": model_info.get("details", {}).get(
