    ...
    try:
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                print(f"✓ Question answering: {qa_result['answer']} (confidence: {qa_result['score']:.3f})")
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                classification_result = classifier("This AI observability tool is really helpful!")
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                summary_result = summarizer(text_to_summarize, max_length=50, min_length=10)
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                features = feature_extractor("This is a test sentence for feature extraction.")
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                print(f"✓ Zero-shot classification: {zero_shot_result['labels'][0]} (confidence: {zero_shot_result['scores'][0]:.3f})")
