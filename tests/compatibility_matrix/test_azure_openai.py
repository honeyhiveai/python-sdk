    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "Say hello and confirm this is an Azure OpenAI compatibility test."}
            ],
            max_tokens=50,
            temperature=0.1
        )
        ...
        with tracer.enrich_span(
            ...
            try:
                ...
                print(f"⚠️  Embedding test failed (deployment may not support embeddings): {e}")
                ...
                print(f"✓ Second chat completion: {response2.choices[0].message.content}")
