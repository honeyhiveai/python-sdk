...
test:
	...
	@docker run -e HH_API_KEY=$$HH_API_KEY -e HH_DATASET=$$HH_DATASET -e HH_PROJECT="$$HH_PROJECT" -e SERP_API_KEY=$$SERP_API_KEY -e OPENAI_API_KEY=$$OPENAI_API_KEY -t my-test
