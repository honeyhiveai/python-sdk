...
from .RunMetricRequestEventFeedback import RunMetricRequestEventFeedback

__all__ = ["RunMetricRequestEvent"]


class RunMetricRequestEvent(BaseModel):
    """
    RunMetricRequestEvent model
    """
    ...
    feedback: Optional[RunMetricRequestEventFeedback] = Field(
