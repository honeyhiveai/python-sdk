...
from .LegacyUpdateMetricRequestFilters import LegacyUpdateMetricRequestFilters

__all__ = ["LegacyUpdateMetricRequest"]


class LegacyUpdateMetricRequest(BaseModel):
    """
    LegacyUpdateMetricRequest model
