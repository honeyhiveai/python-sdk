...
from .LegacyRunMetricRequestMetricFilters import LegacyRunMetricRequestMetricFilters

__all__ = ["LegacyRunMetricRequestMetric"]


class LegacyRunMetricRequestMetric(BaseModel):
    """
    LegacyRunMetricRequestMetric model
    """
    ...
    filters: Optional[LegacyRunMetricRequestMetricFilters] = Field(
