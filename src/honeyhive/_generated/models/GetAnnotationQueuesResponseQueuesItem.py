...
__all__ = ["GetAnnotationQueuesResponseQueuesItem"]


class GetAnnotationQueuesResponseQueuesItem(BaseModel):
    """
    GetAnnotationQueuesResponseQueuesItem model
    """
    ...
    filters: GetAnnotationQueuesResponseQueuesItemFilters = Field(
