...
__all__ = ["CreateAnnotationQueueResponseQueue"]


class CreateAnnotationQueueResponseQueue(BaseModel):
    """
    CreateAnnotationQueueResponseQueue model
    """
    ...
    filters: CreateAnnotationQueueResponseQueueFilters = Field(
