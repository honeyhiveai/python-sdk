...
from ..models import Metric, Metric1, Metric2, MetricEdit, Metrics, Threshold
...
class MetricsAPI(BaseAPI):
    ...
    async def update_metric_from_dict_async(self, metric_id: str, metric_data: dict) -> Metric:
