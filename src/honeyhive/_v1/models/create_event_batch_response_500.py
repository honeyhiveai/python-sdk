...
T = TypeVar("T", bound="CreateEventBatchResponse500")


@_attrs_define
class CreateEventBatchResponse500:
    """
    Example:
        {'event_ids': ['7f22137a-6911-4ed3-bc36-110f1dde6b66', '7f22137a-6911-4ed3-bc36-110f1dde6b67'], 'errors':
            ['Could not create event due to missing inputs', 'Could not create event due to missing source'], 'success':
            True}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_event_batch_response_500 = cls(
            event_ids=event_ids,
            errors=errors,
            success=success,
        )

        create_event_batch_response_500.additional_properties = d
        return create_event_batch_response_500
