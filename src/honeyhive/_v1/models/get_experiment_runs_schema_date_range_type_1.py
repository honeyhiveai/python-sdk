...
T = TypeVar("T", bound="GetExperimentRunsSchemaDateRangeType1")


@_attrs_define
class GetExperimentRunsSchemaDateRangeType1:
    """
    Attributes:
        gte (float | str | Unset):
        lte (float | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_experiment_runs_schema_date_range_type_1 = cls(
            gte=gte,
            lte=lte,
        )

        get_experiment_runs_schema_date_range_type_1.additional_properties = d
        return get_experiment_runs_schema_date_range_type_1
