...
T = TypeVar("T", bound="AddDatapointsToDatasetRequestMapping")


@_attrs_define
class AddDatapointsToDatasetRequestMapping:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_datapoints_to_dataset_request_mapping = cls(
            inputs=inputs,
            history=history,
            ground_truth=ground_truth,
        )

        add_datapoints_to_dataset_request_mapping.additional_properties = d
        return add_datapoints_to_dataset_request_mapping
