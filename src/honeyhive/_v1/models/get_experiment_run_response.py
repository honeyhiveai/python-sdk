...
T = TypeVar("T", bound="GetExperimentRunResponse")


@_attrs_define
class GetExperimentRunResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_experiment_run_response = cls(
            evaluation=evaluation,
        )

        get_experiment_run_response.additional_properties = d
