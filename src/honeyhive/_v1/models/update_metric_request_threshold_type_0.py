...
T = TypeVar("T", bound="UpdateMetricRequestThresholdType0")


@_attrs_define
class UpdateMetricRequestThresholdType0:
    """
    Attributes:
        min_ (float | Unset):
        max_ (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_metric_request_threshold_type_0 = cls(
            min_=min_,
            max_=max_,
            pass_when=pass_when,
        ...
        return update_metric_request_threshold_type_0
