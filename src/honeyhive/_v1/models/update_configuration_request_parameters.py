...
from ..models.update_configuration_request_parameters_call_type import (
    UpdateConfigurationRequestParametersCallType,
)
from ..models.update_configuration_request_parameters_function_call_params import (
    UpdateConfigurationRequestParametersFunctionCallParams,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_configuration_request_parameters_force_function import (
        UpdateConfigurationRequestParametersForceFunction,
    )
    from ..models.update_configuration_request_parameters_hyperparameters import (
        UpdateConfigurationRequestParametersHyperparameters,
    )
    from ..models.update_configuration_request_parameters_response_format import (
        UpdateConfigurationRequestParametersResponseFormat,
    )
    from ..models.update_configuration_request_parameters_selected_functions_item import (
        UpdateConfigurationRequestParametersSelectedFunctionsItem,
    )
    from ..models.update_configuration_request_parameters_template_type_0_item import (
        UpdateConfigurationRequestParametersTemplateType0Item,
    )


T = TypeVar("T", bound="UpdateConfigurationRequestParameters")


@_attrs_define
class UpdateConfigurationRequestParameters:
    """
    Attributes:
        call_type (UpdateConfigurationRequestParametersCallType):
        model (str):
        hyperparameters (UpdateConfigurationRequestParametersHyperparameters | Unset):
        response_format (UpdateConfigurationRequestParametersResponseFormat | Unset):
        selected_functions (list[UpdateConfigurationRequestParametersSelectedFunctionsItem] | Unset):
        function_call_params (UpdateConfigurationRequestParametersFunctionCallParams | Unset):
        force_function (UpdateConfigurationRequestParametersForceFunction | Unset):
        template (list[UpdateConfigurationRequestParametersTemplateType0Item] | str | Unset):
    """

    call_type: UpdateConfigurationRequestParametersCallType
    model: str
    hyperparameters: UpdateConfigurationRequestParametersHyperparameters | Unset = UNSET
    response_format: UpdateConfigurationRequestParametersResponseFormat | Unset = UNSET
    selected_functions: (
        list[UpdateConfigurationRequestParametersSelectedFunctionsItem] | Unset
    ) = UNSET
    function_call_params: (
        UpdateConfigurationRequestParametersFunctionCallParams | Unset
    ) = UNSET
    force_function: UpdateConfigurationRequestParametersForceFunction | Unset = UNSET
    template: (
        list[UpdateConfigurationRequestParametersTemplateType0Item] | str | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        call_type = UpdateConfigurationRequestParametersCallType(d.pop("call_type"))
        ...
        if isinstance(_hyperparameters, Unset):
            ...
            hyperparameters = (
                UpdateConfigurationRequestParametersHyperparameters.from_dict(
                    _hyperparameters
                )
            )
        ...
        if isinstance(_response_format, Unset):
            ...
            response_format = (
                UpdateConfigurationRequestParametersResponseFormat.from_dict(
                    _response_format
                )
            )
        ...
        if _selected_functions is not UNSET:
            ...
            for selected_functions_item_data in _selected_functions:
                selected_functions_item = (
                    UpdateConfigurationRequestParametersSelectedFunctionsItem.from_dict(
        ...
        if isinstance(_force_function, Unset):
            ...
            force_function = (
                UpdateConfigurationRequestParametersForceFunction.from_dict(
                    _force_function
                )
            )
        ...
        def _parse_template(
            ...
            try:
                ...
                pass
            return cast(
                list[UpdateConfigurationRequestParametersTemplateType0Item]
                | str
                | Unset,
                data,
            )
        ...
        update_configuration_request_parameters = cls(
            call_type=call_type,
            model=model,
        ...
        return update_configuration_request_parameters
