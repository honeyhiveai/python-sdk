...
T = TypeVar("T", bound="GetExperimentRunResultQuery")


@_attrs_define
class GetExperimentRunResultQuery:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_experiment_run_result_query = cls(
            aggregate_function=aggregate_function,
            filters=filters,
        )

        get_experiment_run_result_query.additional_properties = d
        return get_experiment_run_result_query
