...
T = TypeVar("T", bound="PostExperimentRunResponse")


@_attrs_define
class PostExperimentRunResponse:
    """
    Attributes:
        run_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_experiment_run_response = cls(
            run_id=run_id,
            evaluation=evaluation,
        )

        post_experiment_run_response.additional_properties = d
