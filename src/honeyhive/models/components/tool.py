...
class Tool:
    ...
    tool_type: Optional[ToolType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tool_type'), 'exclude': lambda f: f is None }})
