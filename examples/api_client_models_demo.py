...
def demonstrate_api_client_usage():
    ...
    print(
        "  client.configurations.create_configuration(request: PostConfigurationRequest)"
    )
    print(
        "  client.configurations.update_configuration(id, request: PutConfigurationRequest)"
    )
    print()
...
def demonstrate_legacy_compatibility():
    ...
    print(
        "  client.sessions.create_session_from_dict({'session_name': 'legacy_session'})"
    )
    print(
        "  client.datapoints.create_datapoint_from_dict({'project': 'demo', 'inputs': {}})"
    )
    print()
