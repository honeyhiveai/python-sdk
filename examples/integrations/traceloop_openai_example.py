...
def advanced_openai_workflow(topic: str) -> Dict[str, Any]:
    ...
    try:
        ...
        enhanced_response = client.chat.completions.create(
            ...
            messages=[
                {"role": "user", "content": f"Enhance this explanation with more technical details:\n\n{initial_content}"}
            ],
            max_tokens=250,
        )
        ...
        enrich_span({
            ...
            "openai.total_tokens": initial_response.usage.total_tokens + enhanced_response.usage.total_tokens,
        ...
        return {
            ...
            "total_tokens": initial_response.usage.total_tokens + enhanced_response.usage.total_tokens,
