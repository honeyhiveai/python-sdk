...
def advanced_anthropic_workflow(document: str) -> Dict[str, Any]:
    ...
    try:
        ...
        summary_response = client.messages.create(
            ...
            max_tokens=200,
            messages=[
                {"role": "user", "content": f"Provide a brief summary of this document:\n\n{document}"}
            ]
        )
        ...
        enrich_span({
            ...
            "anthropic.models_used": ["claude-3-haiku-20240307", "claude-3-sonnet-20240229"],
            "anthropic.total_tokens": summary_response.usage.input_tokens + summary_response.usage.output_tokens + 
...
def demonstrate_cost_tracking():
    ...
    for model in models_to_test:
        ...
        try:
            ...
            print(f"✅ {model}: {response.usage.input_tokens + response.usage.output_tokens} tokens")
