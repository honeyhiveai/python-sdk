...
def tracing_example():
    ...
    tracer = HoneyHiveTracer(
        api_key="your-api-key", project="Example Project", source="example"
    )
...
def verbose_example():
    ...
    client = HoneyHive(
        api_key="your-api-key", verbose=True  # Enable verbose logging for API debugging
    )
    ...
    client.close()
    print(
        "Verbose example completed. Check the logs above for detailed API information."
    )
