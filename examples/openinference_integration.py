...
try:
    ...
    print("OpenInference not available. Install with: pip install openinference-instrumentation-openai")
    ...
    async def async_ai_operation():
        ...
        try:
            ...
            with tracer.start_span("async_ai_operation") as span:
                ...
                print(f"✓ Async OpenAI call completed: {response.choices[0].message.content}")
                return response
    ...
    try:
        ...
        with tracer.start_span("retry_operation") as retry_span:
            ...
            while current_retry < max_retries:
                try:
                    with tracer.start_span(f"attempt_{current_retry + 1}") as attempt_span:
                        ...
                        if response.usage:
                            attempt_span.set_attribute("openai.tokens_used", response.usage.total_tokens)
