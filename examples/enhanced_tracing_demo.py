...
def demonstrate_parent_child_spans(tracer):
    ...
    try:
        ...
        with tracer.start_span("workflow_execution") as parent_span:
            ...
            with tracer.start_span("step_1", parent_id=parent_span.get_span_context().span_id) as child_span:
                ...
                with tracer.start_span("substep_1a", parent_id=child_span.get_span_context().span_id) as grandchild_span:
            ...
            with tracer.start_span("step_2", parent_id=parent_span.get_span_context().span_id) as child_span2:
