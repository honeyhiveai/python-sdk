...
- **Framework Examples**: Integration examples for OpenAI Agents (SwarmAgent), AWS Bedrock (Nova/Titan/Claude models), AWS Strands (TracerProvider pattern), Google ADK (async support), LangGraph (state workflows), Pydantic AI (type-safe agents), and more
